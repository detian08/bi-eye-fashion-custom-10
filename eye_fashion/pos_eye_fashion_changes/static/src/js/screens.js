...
//        ///////////////////////////////////////////////
        ...
        if (!fields.hospital_id) {
            this.gui.show_popup('error',_t('A Hospital Name Is Required'));
            return;
        }

        if (!fields.cyl_data) {
            this.gui.show_popup('error',_t('A CYL Data Is Required'));
            return;
        }

        if (!fields.sph_data) {
            this.gui.show_popup('error',_t('A SPH Data Is Required'));
            return;
        }

        if (!fields.card_id) {
            this.gui.show_popup('error',_t('A Card ID Is Required'));
            return;
        }
//        ////////////////////////////////////
