...
exports.PosModel = Backbone.Model.extend({
    ...
    models: [
    {
        ...
        model:  'res.partner',
        fields: ['name','street','city','state_id','country_id','vat','phone','zip','mobile','email','barcode','write_date','property_account_position_id','parent_id',
                 'sph_data','cyl_data','doctor_id','hospital_id','card_id','expiry_date'],
...
//        loaded: function(self,companiess){ //pass parameters
//        self.companiess = companiess;
//    }
//
