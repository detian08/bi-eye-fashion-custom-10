...
class AccountInvoiceMedical(models.Model):
    _inherit = "account.invoice"

    sale_order_id = fields.Many2one('sale.order','Sale Order',readonly=True,copy=False)
    ...
    date = fields.Date(related='medical_id.date',string='Date',readonly=True)
    # is_pos_refund = fields.Boolean('Is POS Refund', compute='get_pos_refund')
